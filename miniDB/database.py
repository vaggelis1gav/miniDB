...
class Database:
    ...
    def create_table(self, name, column_names, column_types, primary_key=None, load=None):
        ...
        '''
        def create_table_string(self, name, column_names, column_types, primary_key(string), foreign_key(the primary key to the corresponding strong relatioship), check(balance > = 0)
